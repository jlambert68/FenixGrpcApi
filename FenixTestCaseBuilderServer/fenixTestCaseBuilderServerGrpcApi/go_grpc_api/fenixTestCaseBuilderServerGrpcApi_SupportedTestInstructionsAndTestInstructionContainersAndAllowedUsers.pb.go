...
type SignedMessageByWorkerServiceAccountMessage struct {
	...
	Signature                  []byte `protobuf:"bytes,2,opt,name=Signature,proto3" json:"Signature,omitempty"`                                   // The signature produced when signing the message
...
func (x *SignedMessageByWorkerServiceAccountMessage) GetSignature() []byte {
	if x != nil {
		return x.Signature
	}
	return nil
