...
type BasicBondInformationMessage_VisibleBondAttributesMessage struct {
	...
	UpdatedTimeStamp         *timestamp.Timestamp         `protobuf:"bytes,11,opt,name=UpdatedTimeStamp,proto3" json:"UpdatedTimeStamp,omitempty"`                                                                                      // The TimeStamp when the Bond was last updated
...
func (x *BasicBondInformationMessage_VisibleBondAttributesMessage) GetUpdatedTimeStamp() *timestamp.Timestamp {
	if x != nil {
...
type MatureBondInformationMessage_CreatedAndUpdatedInformationMessage struct {
	...
	LastUpdatedInTestCaseTimeStamp *timestamp.Timestamp `protobuf:"bytes,3,opt,name=LastUpdatedInTestCaseTimeStamp,proto3" json:"LastUpdatedInTestCaseTimeStamp,omitempty"` // The TimeStamp when the Bond was updated in the TestCase
	...
	DeletedFromTestCaseTimeStamp   *timestamp.Timestamp `protobuf:"bytes,5,opt,name=DeletedFromTestCaseTimeStamp,proto3" json:"DeletedFromTestCaseTimeStamp,omitempty"`     // The TimeStamp when the Bond was was deleted from the TestCase
...
func (x *MatureBondInformationMessage_CreatedAndUpdatedInformationMessage) GetAddedToTestCaseTimeStamp() *timestamp.Timestamp {
	if x != nil {
...
func (x *MatureBondInformationMessage_CreatedAndUpdatedInformationMessage) GetLastUpdatedInTestCaseTimeStamp() *timestamp.Timestamp {
	if x != nil {
...
func (x *MatureBondInformationMessage_CreatedAndUpdatedInformationMessage) GetDeletedFromTestCaseTimeStamp() *timestamp.Timestamp {
	if x != nil {
