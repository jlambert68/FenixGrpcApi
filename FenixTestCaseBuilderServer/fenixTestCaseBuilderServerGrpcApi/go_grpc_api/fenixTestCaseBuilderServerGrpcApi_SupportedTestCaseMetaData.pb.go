...
type ListTestCaseAndTestSuiteMetaDataResponseMessage struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	TestCaseAndTestSuiteMetaDataForDomains []*TestCaseAndTestSuiteMetaDataForOneDomainMessage `protobuf:"bytes,2,rep,name=TestCaseAndTestSuiteMetaDataForDomains,proto3" json:"TestCaseAndTestSuiteMetaDataForDomains,omitempty"` // A list of all URLs tha the user can use when picking templates in TestCases
}

func (x *ListTestCaseAndTestSuiteMetaDataResponseMessage) Reset() {
	*x = ListTestCaseAndTestSuiteMetaDataResponseMessage{}
	if protoimpl.UnsafeEnabled {
...
func (x *ListTestCaseAndTestSuiteMetaDataResponseMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListTestCaseAndTestSuiteMetaDataResponseMessage) ProtoMessage() {}

func (x *ListTestCaseAndTestSuiteMetaDataResponseMessage) ProtoReflect() protoreflect.Message {
	mi := &file_FenixTestCaseBuilderServer_fenixTestCaseBuilderServerGrpcApi_fenixTestCaseBuilderServerGrpcApi_SupportedTestCaseMetaData_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListTestCaseAndTestSuiteMetaDataResponseMessage.ProtoReflect.Descriptor instead.
func (*ListTestCaseAndTestSuiteMetaDataResponseMessage) Descriptor() ([]byte, []int) {
...
func (x *ListTestCaseAndTestSuiteMetaDataResponseMessage) GetAckNackResponse() *AckNackResponse {
	if x != nil {
...
func (x *ListTestCaseAndTestSuiteMetaDataResponseMessage) GetTestCaseAndTestSuiteMetaDataForDomains() []*TestCaseAndTestSuiteMetaDataForOneDomainMessage {
	if x != nil {
		return x.TestCaseAndTestSuiteMetaDataForDomains
	}
	return nil
}
...
type TestCaseAndTestSuiteMetaDataForOneDomainMessage struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	TestSuiteMetaDataAsJson string `protobuf:"bytes,4,opt,name=TestSuiteMetaDataAsJson,proto3" json:"TestSuiteMetaDataAsJson,omitempty"` // All supported metadata in json-format
}

func (x *TestCaseAndTestSuiteMetaDataForOneDomainMessage) Reset() {
	*x = TestCaseAndTestSuiteMetaDataForOneDomainMessage{}
	if protoimpl.UnsafeEnabled {
...
func (x *TestCaseAndTestSuiteMetaDataForOneDomainMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TestCaseAndTestSuiteMetaDataForOneDomainMessage) ProtoMessage() {}

func (x *TestCaseAndTestSuiteMetaDataForOneDomainMessage) ProtoReflect() protoreflect.Message {
	mi := &file_FenixTestCaseBuilderServer_fenixTestCaseBuilderServerGrpcApi_fenixTestCaseBuilderServerGrpcApi_SupportedTestCaseMetaData_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TestCaseAndTestSuiteMetaDataForOneDomainMessage.ProtoReflect.Descriptor instead.
func (*TestCaseAndTestSuiteMetaDataForOneDomainMessage) Descriptor() ([]byte, []int) {
...
func (x *TestCaseAndTestSuiteMetaDataForOneDomainMessage) GetDomainUuid() string {
	if x != nil {
		return x.DomainUuid
	}
	return ""
...
func (x *TestCaseAndTestSuiteMetaDataForOneDomainMessage) GetDomainName() string {
	if x != nil {
		return x.DomainName
	}
	return ""
...
func (x *TestCaseAndTestSuiteMetaDataForOneDomainMessage) GetTestCaseMetaDataAsJson() string {
	if x != nil {
...
func (x *TestCaseAndTestSuiteMetaDataForOneDomainMessage) GetTestSuiteMetaDataAsJson() string {
	if x != nil {
		return x.TestSuiteMetaDataAsJson
	}
	return ""
}
...
var file_FenixTestCaseBuilderServer_fenixTestCaseBuilderServerGrpcApi_fenixTestCaseBuilderServerGrpcApi_SupportedTestCaseMetaData_proto_rawDesc = []byte{
	...
	0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x44, 0x61, 0x74, 0x61, 0x22, 0xbc, 0x02, 0x0a,
	0x2f, 0x4c, 0x69, 0x73, 0x74, 0x54, 0x65, 0x73, 0x74, 0x43, 0x61, 0x73, 0x65, 0x41, 0x6e, 0x64,
	0x54, 0x65, 0x73, 0x74, 0x53, 0x75, 0x69, 0x74, 0x65, 0x4d, 0x65, 0x74, 0x61, 0x44, 0x61, 0x74,
	0x61, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	...
	0x63, 0x6b, 0x4e, 0x61, 0x63, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0xaa,
	0x01, 0x0a, 0x26, 0x54, 0x65, 0x73, 0x74, 0x43, 0x61, 0x73, 0x65, 0x41, 0x6e, 0x64, 0x54, 0x65,
	0x73, 0x74, 0x53, 0x75, 0x69, 0x74, 0x65, 0x4d, 0x65, 0x74, 0x61, 0x44, 0x61, 0x74, 0x61, 0x46,
	...
	0x75, 0x69, 0x6c, 0x64, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x47, 0x72, 0x70, 0x63,
	0x41, 0x70, 0x69, 0x2e, 0x54, 0x65, 0x73, 0x74, 0x43, 0x61, 0x73, 0x65, 0x41, 0x6e, 0x64, 0x54,
	...
	0x61, 0x67, 0x65, 0x52, 0x26, 0x54, 0x65, 0x73, 0x74, 0x43, 0x61, 0x73, 0x65, 0x41, 0x6e, 0x64,
	0x54, 0x65, 0x73, 0x74, 0x53, 0x75, 0x69, 0x74, 0x65, 0x4d, 0x65, 0x74, 0x61, 0x44, 0x61, 0x74,
	0x61, 0x46, 0x6f, 0x72, 0x44, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x73, 0x22, 0xe3, 0x01, 0x0a, 0x2f,
	0x54, 0x65, 0x73, 0x74, 0x43, 0x61, 0x73, 0x65, 0x41, 0x6e, 0x64, 0x54, 0x65, 0x73, 0x74, 0x53,
	0x75, 0x69, 0x74, 0x65, 0x4d, 0x65, 0x74, 0x61, 0x44, 0x61, 0x74, 0x61, 0x46, 0x6f, 0x72, 0x4f,
	0x6e, 0x65, 0x44, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12,
	...
	,
...
var file_FenixTestCaseBuilderServer_fenixTestCaseBuilderServerGrpcApi_fenixTestCaseBuilderServerGrpcApi_SupportedTestCaseMetaData_proto_goTypes = []interface{}{
	...
	(*ListTestCaseAndTestSuiteMetaDataResponseMessage)(nil), // 1: fenixTestCaseBuilderServerGrpcApi.ListTestCaseAndTestSuiteMetaDataResponseMessage
	(*TestCaseAndTestSuiteMetaDataForOneDomainMessage)(nil), // 2: fenixTestCaseBuilderServerGrpcApi.TestCaseAndTestSuiteMetaDataForOneDomainMessage
...
var file_FenixTestCaseBuilderServer_fenixTestCaseBuilderServerGrpcApi_fenixTestCaseBuilderServerGrpcApi_SupportedTestCaseMetaData_proto_depIdxs = []int32{
	...
	5, // 2: fenixTestCaseBuilderServerGrpcApi.ListTestCaseAndTestSuiteMetaDataResponseMessage.ackNackResponse:type_name -> fenixTestCaseBuilderServerGrpcApi.AckNackResponse
	2, // 3: fenixTestCaseBuilderServerGrpcApi.ListTestCaseAndTestSuiteMetaDataResponseMessage.TestCaseAndTestSuiteMetaDataForDomains:type_name -> fenixTestCaseBuilderServerGrpcApi.TestCaseAndTestSuiteMetaDataForOneDomainMessage
...
func file_FenixTestCaseBuilderServer_fenixTestCaseBuilderServerGrpcApi_fenixTestCaseBuilderServerGrpcApi_SupportedTestCaseMetaData_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_FenixTestCaseBuilderServer_fenixTestCaseBuilderServerGrpcApi_fenixTestCaseBuilderServerGrpcApi_SupportedTestCaseMetaData_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListTestCaseAndTestSuiteMetaDataResponseMessage); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_FenixTestCaseBuilderServer_fenixTestCaseBuilderServerGrpcApi_fenixTestCaseBuilderServerGrpcApi_SupportedTestCaseMetaData_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TestCaseAndTestSuiteMetaDataForOneDomainMessage); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
