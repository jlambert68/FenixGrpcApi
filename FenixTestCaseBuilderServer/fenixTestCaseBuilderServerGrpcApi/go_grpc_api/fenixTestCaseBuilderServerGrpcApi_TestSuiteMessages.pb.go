...
type BasicTestSuiteInformationMessage struct {
	...
	LatestTestSuiteExecutionStatusInsertTimeStamp           *timestamp.Timestamp                                                 `protobuf:"bytes,4,opt,name=LatestTestSuiteExecutionStatusInsertTimeStamp,proto3" json:"LatestTestSuiteExecutionStatusInsertTimeStamp,omitempty"`                                        // The TimeStamp when this 'TestSuiteExecution' was inserted into the Database
	LatestFinishedOkTestSuiteExecutionStatusInsertTimeStamp *timestamp.Timestamp                                                 `protobuf:"bytes,5,opt,name=LatestFinishedOkTestSuiteExecutionStatusInsertTimeStamp,proto3" json:"LatestFinishedOkTestSuiteExecutionStatusInsertTimeStamp,omitempty"`                    // The TimeStamp when the latest OK 'TestSuiteExecution' was inserted into the Database
	LastSavedTimeStamp                                      *timestamp.Timestamp                                                 `protobuf:"bytes,6,opt,name=LastSavedTimeStamp,proto3" json:"LastSavedTimeStamp,omitempty"`                                                                                              // The TimeStamp when the TestSuite was last saved into the Database
...
func (x *BasicTestSuiteInformationMessage) GetLatestTestSuiteExecutionStatusInsertTimeStamp() *timestamp.Timestamp {
	if x != nil {
...
func (x *BasicTestSuiteInformationMessage) GetLatestFinishedOkTestSuiteExecutionStatusInsertTimeStamp() *timestamp.Timestamp {
	if x != nil {
...
func (x *BasicTestSuiteInformationMessage) GetLastSavedTimeStamp() *timestamp.Timestamp {
	if x != nil {
