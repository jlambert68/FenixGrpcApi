...
type ListAllTestInstructionContainersForSpecificTestCaseRequestMessage struct {
	...
	TestCaseUuid                 string                                          `protobuf:"bytes,4,opt,name=TestCaseUuid,proto3" json:"TestCaseUuid,omitempty"`                                                                                                                         // The TestCase, UUID, that is TestInstructionContainers belong to
}
...
func (x *ListAllTestInstructionContainersForSpecificTestCaseRequestMessage) GetUserIdOnComputer() string {
	if x != nil {
...
func (x *ListAllTestInstructionContainersForSpecificTestCaseRequestMessage) GetGCPAuthenticatedUser() string {
	if x != nil {
...
type SaveAllTestInstructionContainersForSpecificTestCaseRequestMessage struct {
	...
	MatureTestInstructionContainers *MatureTestInstructionContainersMessage         `protobuf:"bytes,5,opt,name=MatureTestInstructionContainers,proto3" json:"MatureTestInstructionContainers,omitempty"`                                                                                   // All TestInstructionContainers to be saved
}
...
func (x *SaveAllTestInstructionContainersForSpecificTestCaseRequestMessage) GetUserIdOnComputer() string {
	if x != nil {
		return x.UserIdOnComputer
	}
	return ""
...
func (x *SaveAllTestInstructionContainersForSpecificTestCaseRequestMessage) GetGCPAuthenticatedUser() string {
	if x != nil {
		return x.GCPAuthenticatedUser
	}
	return ""
...
var file_FenixTestCaseBuilderServer_fenixTestCaseBuilderServerGrpcApi_fenixTestCaseBuilderServerGrpcApi_TestInstructionContainerMessages_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe0, 0x02, 0x0a, 0x41, 0x4c, 0x69, 0x73, 0x74, 0x41,
	...
	0x6c, 0x69, 0x65, 0x6e, 0x74, 0x12, 0x22, 0x0a, 0x0c, 0x54, 0x65, 0x73, 0x74, 0x43, 0x61, 0x73,
	0x65, 0x55, 0x75, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x54, 0x65, 0x73,
	0x74, 0x43, 0x61, 0x73, 0x65, 0x55, 0x75, 0x69, 0x64, 0x22, 0xf6, 0x03, 0x0a, 0x41, 0x53, 0x61,
	...
	0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x49, 0x2e, 0x66, 0x65, 0x6e, 0x69, 0x78, 0x54, 0x65,
	0x73, 0x74, 0x43, 0x61, 0x73, 0x65, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x65, 0x72, 0x53, 0x65, 0x72,
