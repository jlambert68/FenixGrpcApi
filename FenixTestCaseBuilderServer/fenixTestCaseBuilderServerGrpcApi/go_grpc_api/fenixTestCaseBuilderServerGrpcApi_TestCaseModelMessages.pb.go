...
type TestCaseModelElementMessage struct {
	...
	FirstChildElementUuid    string                       `protobuf:"bytes,6,opt,name=FirstChildElementUuid,proto3" json:"FirstChildElementUuid,omitempty"`                                                                            // The UUID of the first child element. Only applicable when this is a TestInstructionContainer
	ParentElementUuid        string                       `protobuf:"bytes,7,opt,name=ParentElementUuid,proto3" json:"ParentElementUuid,omitempty"`                                                                                    // The UUID of the parent, TestInstructionContainer. Only applicable when this is the last element inside a TestInstructionContainer
