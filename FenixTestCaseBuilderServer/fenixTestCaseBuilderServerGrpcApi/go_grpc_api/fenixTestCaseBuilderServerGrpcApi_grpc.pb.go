...
const (
	...
	FenixTestCaseBuilderServerGrpcServices_ListTestSuitesThatCanBeEdited_FullMethodName                                      = "/fenixTestCaseBuilderServerGrpcApi.FenixTestCaseBuilderServerGrpcServices/ListTestSuitesThatCanBeEdited"
	...
	FenixTestCaseBuilderServerGrpcServices_DeleteTestSuiteAtThisDate_FullMethodName                                          = "/fenixTestCaseBuilderServerGrpcApi.FenixTestCaseBuilderServerGrpcServices/DeleteTestSuiteAtThisDate"
)
...
type FenixTestCaseBuilderServerGrpcServicesClient interface {
	...
	// List TestSuites that the user can edit
	ListTestSuitesThatCanBeEdited(ctx context.Context, in *ListTestSuitesRequestMessage, opts ...grpc.CallOption) (*ListTestSuitesResponseMessage, error)
	...
	DeleteTestSuiteAtThisDate(ctx context.Context, in *DeleteTestSuiteAtThisDateRequest, opts ...grpc.CallOption) (*AckNackResponse, error)
}
...
func (c *fenixTestCaseBuilderServerGrpcServicesClient) ListTestSuitesThatCanBeEdited(ctx context.Context, in *ListTestSuitesRequestMessage, opts ...grpc.CallOption) (*ListTestSuitesResponseMessage, error) {
	out := new(ListTestSuitesResponseMessage)
	err := c.cc.Invoke(ctx, FenixTestCaseBuilderServerGrpcServices_ListTestSuitesThatCanBeEdited_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *fenixTestCaseBuilderServerGrpcServicesClient) DeleteTestSuiteAtThisDate(ctx context.Context, in *DeleteTestSuiteAtThisDateRequest, opts ...grpc.CallOption) (*AckNackResponse, error) {
	out := new(AckNackResponse)
	err := c.cc.Invoke(ctx, FenixTestCaseBuilderServerGrpcServices_DeleteTestSuiteAtThisDate_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FenixTestCaseBuilderServerGrpcServicesServer interface {
	...
	// List TestSuites that the user can edit
	ListTestSuitesThatCanBeEdited(context.Context, *ListTestSuitesRequestMessage) (*ListTestSuitesResponseMessage, error)
	// Save full TestCase in DB
	...
	// *** TesterGui send Delete-command that updates database that TestSuite will be delete per a certain date ***
	DeleteTestSuiteAtThisDate(context.Context, *DeleteTestSuiteAtThisDateRequest) (*AckNackResponse, error)
...
func (UnimplementedFenixTestCaseBuilderServerGrpcServicesServer) ListTestSuitesThatCanBeEdited(context.Context, *ListTestSuitesRequestMessage) (*ListTestSuitesResponseMessage, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListTestSuitesThatCanBeEdited not implemented")
}
...
func (UnimplementedFenixTestCaseBuilderServerGrpcServicesServer) DeleteTestSuiteAtThisDate(context.Context, *DeleteTestSuiteAtThisDateRequest) (*AckNackResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteTestSuiteAtThisDate not implemented")
}
...
func _FenixTestCaseBuilderServerGrpcServices_ListTestSuitesThatCanBeEdited_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListTestSuitesRequestMessage)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FenixTestCaseBuilderServerGrpcServicesServer).ListTestSuitesThatCanBeEdited(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FenixTestCaseBuilderServerGrpcServices_ListTestSuitesThatCanBeEdited_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FenixTestCaseBuilderServerGrpcServicesServer).ListTestSuitesThatCanBeEdited(ctx, req.(*ListTestSuitesRequestMessage))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _FenixTestCaseBuilderServerGrpcServices_DeleteTestSuiteAtThisDate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteTestSuiteAtThisDateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FenixTestCaseBuilderServerGrpcServicesServer).DeleteTestSuiteAtThisDate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FenixTestCaseBuilderServerGrpcServices_DeleteTestSuiteAtThisDate_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FenixTestCaseBuilderServerGrpcServicesServer).DeleteTestSuiteAtThisDate(ctx, req.(*DeleteTestSuiteAtThisDateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FenixTestCaseBuilderServerGrpcServices_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListTestSuitesThatCanBeEdited",
			Handler:    _FenixTestCaseBuilderServerGrpcServices_ListTestSuitesThatCanBeEdited_Handler,
		},
		{
		...
		{
			MethodName: "DeleteTestSuiteAtThisDate",
			Handler:    _FenixTestCaseBuilderServerGrpcServices_DeleteTestSuiteAtThisDate_Handler,
		},
	},
...
const (
	...
	FenixTestCaseBuilderServerGrpcWorkerServices_ConnectorPublishSupportedMetaData_FullMethodName                                           = "/fenixTestCaseBuilderServerGrpcApi.FenixTestCaseBuilderServerGrpcWorkerServices/ConnectorPublishSupportedMetaData"
	FenixTestCaseBuilderServerGrpcWorkerServices_ConnectorPublishSupportedSubInstructions_FullMethodName                                    = "/fenixTestCaseBuilderServerGrpcApi.FenixTestCaseBuilderServerGrpcWorkerServices/ConnectorPublishSupportedSubInstructions"
...
type FenixTestCaseBuilderServerGrpcWorkerServicesClient interface {
	...
	// Connector Publish Support SubInstructions for the Domain
	ConnectorPublishSupportedSubInstructions(ctx context.Context, in *SupportedSubInstructions, opts ...grpc.CallOption) (*AckNackResponse, error)
...
func (c *fenixTestCaseBuilderServerGrpcWorkerServicesClient) ConnectorPublishSupportedSubInstructions(ctx context.Context, in *SupportedSubInstructions, opts ...grpc.CallOption) (*AckNackResponse, error) {
	out := new(AckNackResponse)
	err := c.cc.Invoke(ctx, FenixTestCaseBuilderServerGrpcWorkerServices_ConnectorPublishSupportedSubInstructions_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FenixTestCaseBuilderServerGrpcWorkerServicesServer interface {
	...
	// Connector Publish Support SubInstructions for the Domain
	ConnectorPublishSupportedSubInstructions(context.Context, *SupportedSubInstructions) (*AckNackResponse, error)
	// Worker ask TestCaseBuilderServer for a Message to Sign to be able to prove identity
...
func (UnimplementedFenixTestCaseBuilderServerGrpcWorkerServicesServer) ConnectorPublishSupportedSubInstructions(context.Context, *SupportedSubInstructions) (*AckNackResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ConnectorPublishSupportedSubInstructions not implemented")
}
...
func _FenixTestCaseBuilderServerGrpcWorkerServices_ConnectorPublishSupportedMetaData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(FenixTestCaseBuilderServerGrpcWorkerServicesServer).ConnectorPublishSupportedMetaData(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
func _FenixTestCaseBuilderServerGrpcWorkerServices_ConnectorPublishSupportedSubInstructions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SupportedSubInstructions)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FenixTestCaseBuilderServerGrpcWorkerServicesServer).ConnectorPublishSupportedSubInstructions(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FenixTestCaseBuilderServerGrpcWorkerServices_ConnectorPublishSupportedSubInstructions_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FenixTestCaseBuilderServerGrpcWorkerServicesServer).ConnectorPublishSupportedSubInstructions(ctx, req.(*SupportedSubInstructions))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FenixTestCaseBuilderServerGrpcWorkerServices_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _FenixTestCaseBuilderServerGrpcWorkerServices_ConnectorPublishSupportedMetaData_Handler,
		},
		{
			MethodName: "ConnectorPublishSupportedSubInstructions",
			Handler:    _FenixTestCaseBuilderServerGrpcWorkerServices_ConnectorPublishSupportedSubInstructions_Handler,
		},
		{
