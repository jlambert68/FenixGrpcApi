...
type TestInstructionMessage struct {
	...
	TestInstructionUuid          string `protobuf:"bytes,5,opt,name=TestInstructionUuid,proto3" json:"TestInstructionUuid,omitempty"`                    // TestInstruction UUID
	TestInstructionName          string `protobuf:"bytes,6,opt,name=TestInstructionName,proto3" json:"TestInstructionName,omitempty"`                    // TestInstruction Name
	...
	TestInstructionDescription   string `protobuf:"bytes,9,opt,name=TestInstructionDescription,proto3" json:"TestInstructionDescription,omitempty"`      // The description of the TestInstruction
	TestInstructionMouseOverText string `protobuf:"bytes,10,opt,name=TestInstructionMouseOverText,proto3" json:"TestInstructionMouseOverText,omitempty"` // The mouse over text when hovering over TestInstruction
	Deprecated                   bool   `protobuf:"varint,11,opt,name=Deprecated,proto3" json:"Deprecated,omitempty"`                                    // Indicates that this TestInstruction shouldn't be used anymore
	Enabled                      bool   `protobuf:"varint,12,opt,name=Enabled,proto3" json:"Enabled,omitempty"`                                          // TestInstruction can be disabled when the user shouldn't use it anymore
	MajorVersionNumber           uint32 `protobuf:"varint,13,opt,name=MajorVersionNumber,proto3" json:"MajorVersionNumber,omitempty"`                    // Change in Major Version Number means that user must act on change
	MinorVersionNumber           uint32 `protobuf:"varint,14,opt,name=MinorVersionNumber,proto3" json:"MinorVersionNumber,omitempty"`                    // Change in Minor Version Number means that user must NOT act on change
	UpdatedTimeStamp             uint32 `protobuf:"varint,15,opt,name=UpdatedTimeStamp,proto3" json:"UpdatedTimeStamp,omitempty"`                        // The TimeStamp when the TestInstruction was last updated
}
...
func (x *TestInstructionMessage) GetSystemUuid() string {
	if x != nil {
		return x.SystemUuid
	}
	return ""
...
func (x *TestInstructionMessage) GetSystemName() string {
	if x != nil {
		return x.SystemName
	}
	return ""
...
func (x *TestInstructionMessage) GetUpdatedTimeStamp() uint32 {
	if x != nil {
...
type TestInstructionContainerMessage struct {
	...
	SystemUuid                            string                                    `protobuf:"bytes,3,opt,name=SystemUuid,proto3" json:"SystemUuid,omitempty"`                                                                                                                                          // The System, UUID, where the TestInstructions and TestInstruction can be used
	SystemName                            string                                    `protobuf:"bytes,4,opt,name=SystemName,proto3" json:"SystemName,omitempty"`                                                                                                                                          // The System, Name, where the TestInstructions and TestInstruction can be used
	TestInstructionContainerUuid          string                                    `protobuf:"bytes,5,opt,name=TestInstructionContainerUuid,proto3" json:"TestInstructionContainerUuid,omitempty"`                                                                                                      // TestInstructionContainer UUID
	TestInstructionContainerName          string                                    `protobuf:"bytes,6,opt,name=TestInstructionContainerName,proto3" json:"TestInstructionContainerName,omitempty"`                                                                                                      // TestInstructionContainer Name
	TestInstructionContainerTypeUuid      string                                    `protobuf:"bytes,7,opt,name=TestInstructionContainerTypeUuid,proto3" json:"TestInstructionContainerTypeUuid,omitempty"`                                                                                              // The Type(Group), Uuid, of TestInstructionContainer
	TestInstructionContainerTypeName      string                                    `protobuf:"bytes,8,opt,name=TestInstructionContainerTypeName,proto3" json:"TestInstructionContainerTypeName,omitempty"`                                                                                              // The Type(Group), Name, of TestInstructionContainer
	TestInstructionContainerDescription   string                                    `protobuf:"bytes,9,opt,name=TestInstructionContainerDescription,proto3" json:"TestInstructionContainerDescription,omitempty"`                                                                                        // The description of the TestInstructionContainer
	TestInstructionContainerMouseOverText string                                    `protobuf:"bytes,10,opt,name=TestInstructionContainerMouseOverText,proto3" json:"TestInstructionContainerMouseOverText,omitempty"`                                                                                   // The mouse over text when hovering over TestInstructionContainer
	Deprecated                            bool                                      `protobuf:"varint,11,opt,name=Deprecated,proto3" json:"Deprecated,omitempty"`                                                                                                                                        // Indicates that this TestInstructionContainer shouldn't be used anymore
	Enabled                               bool                                      `protobuf:"varint,12,opt,name=Enabled,proto3" json:"Enabled,omitempty"`                                                                                                                                              // TestInstructionContainer can be disabled when the user shouldn't use it anymore
	MajorVersionNumber                    uint32                                    `protobuf:"varint,13,opt,name=MajorVersionNumber,proto3" json:"MajorVersionNumber,omitempty"`                                                                                                                        // Change in Major Version Number means that user must act on change
	MinorVersionNumber                    uint32                                    `protobuf:"varint,14,opt,name=MinorVersionNumber,proto3" json:"MinorVersionNumber,omitempty"`                                                                                                                        // Change in Minor Version Number means that user must NOT act on change
	UpdatedTimeStamp                      uint32                                    `protobuf:"varint,15,opt,name=UpdatedTimeStamp,proto3" json:"UpdatedTimeStamp,omitempty"`                                                                                                                            // The TimeStamp when the TestInstructionContainer was last updated
	TestInstructionContainerExecutionType TestInstructionContainerExecutionTypeEnum `protobuf:"varint,16,opt,name=TestInstructionContainerExecutionType,proto3,enum=fenixTestCaseBuilderServerGrpcApi.TestInstructionContainerExecutionTypeEnum" json:"TestInstructionContainerExecutionType,omitempty"` // Defines if the children of TestInstructionContainer is processed in parallel or in seral
	TestInstructionContainerChildren      []string                                  `protobuf:"bytes,17,rep,name=TestInstructionContainerChildren,proto3" json:"TestInstructionContainerChildren,omitempty"`                                                                                             // A list of the children[UUID's] in the this container. Can be TestInstructions or TestInstructionContainers. Order is specified by the order in the array
}
...
func (x *TestInstructionContainerMessage) GetSystemUuid() string {
	if x != nil {
		return x.SystemUuid
	}
	return ""
...
func (x *TestInstructionContainerMessage) GetSystemName() string {
	if x != nil {
		return x.SystemName
	}
	return ""
...
func (x *TestInstructionContainerMessage) GetUpdatedTimeStamp() uint32 {
	if x != nil {
		return x.UpdatedTimeStamp
	}
	return 0
...
var file_fenixTestCaseBuilderServerGrpcApi_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x76, 0x65, 0x72, 0x47, 0x72, 0x70, 0x63, 0x41, 0x70, 0x69, 0x22, 0xa9, 0x01, 0x0a,
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x52, 0x2e, 0x66, 0x65, 0x6e, 0x69, 0x78, 0x54, 0x65,
	...
	0x42, 0x79, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x22, 0x9a, 0x01, 0x0a, 0x0f, 0x41, 0x63, 0x6b,
	...
	0x74, 0x73, 0x12, 0x51, 0x0a, 0x0a, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x43, 0x6f, 0x64, 0x65, 0x73,
	0x18, 0x03, 0x20, 0x03, 0x28, 0x0e, 0x32, 0x31, 0x2e, 0x66, 0x65, 0x6e, 0x69, 0x78, 0x54, 0x65,
	0x73, 0x74, 0x43, 0x61, 0x73, 0x65, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x65, 0x72, 0x53, 0x65, 0x72,
	0x76, 0x65, 0x72, 0x47, 0x72, 0x70, 0x63, 0x41, 0x70, 0x69, 0x2e, 0x45, 0x72, 0x72, 0x6f, 0x72,
	0x43, 0x6f, 0x64, 0x65, 0x73, 0x45, 0x6e, 0x75, 0x6d, 0x52, 0x0a, 0x45, 0x72, 0x72, 0x6f, 0x72,
	0x43, 0x6f, 0x64, 0x65, 0x73, 0x22, 0xcc, 0x01, 0x0a, 0x19, 0x55, 0x73, 0x65, 0x72, 0x49, 0x64,
	...
	0x69, 0x65, 0x6e, 0x74, 0x22, 0x8e, 0x03, 0x0a, 0x28, 0x54, 0x65, 0x73, 0x74, 0x49, 0x6e, 0x73,
	...
	,
	...
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x12, 0x5c, 0x0a, 0x0f, 0x61, 0x63, 0x6b, 0x4e, 0x61,
	0x63, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x32, 0x2e, 0x66, 0x65, 0x6e, 0x69, 0x78, 0x54, 0x65, 0x73, 0x74, 0x43, 0x61, 0x73, 0x65,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x94, 0x03, 0x0a, 0x2e, 0x50, 0x69, 0x6e, 0x6e, 0x65, 0x64,
	0x54, 0x65, 0x73, 0x74, 0x49, 0x6e, 0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73,
	0x41, 0x6e, 0x64, 0x54, 0x65, 0x73, 0x74, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72,
	0x73, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x73, 0x0a, 0x17, 0x54, 0x65, 0x73, 0x74,
	0x49, 0x6e, 0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x4d, 0x65, 0x73, 0x73, 0x61,
	0x67, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x39, 0x2e, 0x66, 0x65, 0x6e, 0x69,
	...
	0x73, 0x61, 0x67, 0x65, 0x52, 0x17, 0x54, 0x65, 0x73, 0x74, 0x49, 0x6e, 0x73, 0x74, 0x72, 0x75,
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x12, 0x8e, 0x01,
	...
	0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x42, 0x2e, 0x66, 0x65, 0x6e, 0x69, 0x78,
	0x54, 0x65, 0x73, 0x74, 0x43, 0x61, 0x73, 0x65, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x65, 0x72, 0x53,
	...
	0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x12, 0x5c,
	0x0a, 0x0f, 0x61, 0x63, 0x6b, 0x4e, 0x61, 0x63, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x32, 0x2e, 0x66, 0x65, 0x6e, 0x69, 0x78, 0x54,
	...
	0x4e, 0x61, 0x63, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xba, 0x05, 0x0a,
	...
	0x61, 0x69, 0x6e, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x1e, 0x0a, 0x0a, 0x53, 0x79, 0x73, 0x74, 0x65,
	0x6d, 0x55, 0x75, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x53, 0x79, 0x73,
	0x74, 0x65, 0x6d, 0x55, 0x75, 0x69, 0x64, 0x12, 0x1e, 0x0a, 0x0a, 0x53, 0x79, 0x73, 0x74, 0x65,
	0x6d, 0x4e, 0x61, 0x6d, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x53, 0x79, 0x73,
	0x74, 0x65, 0x6d, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x30, 0x0a, 0x13, 0x54, 0x65, 0x73, 0x74, 0x49,
	...
	0x70, 0x65, 0x55, 0x75, 0x69, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x17, 0x54, 0x65,
	...
	0x6f, 0x6e, 0x44, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x09, 0x20,
	...
	0x65, 0x78, 0x74, 0x12, 0x1e, 0x0a, 0x0a, 0x44, 0x65, 0x70, 0x72, 0x65, 0x63, 0x61, 0x74, 0x65,
	0x64, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a, 0x44, 0x65, 0x70, 0x72, 0x65, 0x63, 0x61,
	0x74, 0x65, 0x64, 0x12, 0x18, 0x0a, 0x07, 0x45, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x18, 0x0c,
	0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x45, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x12, 0x2e, 0x0a,
	0x12, 0x4d, 0x61, 0x6a, 0x6f, 0x72, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x4e, 0x75, 0x6d,
	0x62, 0x65, 0x72, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x12, 0x4d, 0x61, 0x6a, 0x6f, 0x72,
	...
	0x62, 0x65, 0x72, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x12, 0x4d, 0x69, 0x6e, 0x6f, 0x72,
	...
	0x70, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x10, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64,
	0x54, 0x69, 0x6d, 0x65, 0x53, 0x74, 0x61, 0x6d, 0x70, 0x22, 0xa0, 0x08, 0x0a, 0x1f, 0x54, 0x65,
	0x73, 0x74, 0x49, 0x6e, 0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x6e,
	0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x1e, 0x0a,
	...
	0x09, 0x52, 0x0a, 0x44, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x1e, 0x0a,
	0x0a, 0x53, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x55, 0x75, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x0a, 0x53, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x55, 0x75, 0x69, 0x64, 0x12, 0x1e, 0x0a,
	0x0a, 0x53, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x4e, 0x61, 0x6d, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x0a, 0x53, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x42, 0x0a,
	0x1c, 0x54, 0x65, 0x73, 0x74, 0x49, 0x6e, 0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x55, 0x75, 0x69, 0x64, 0x18, 0x05, 0x20,
	...
	0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x1c, 0x54, 0x65, 0x73, 0x74, 0x49, 0x6e, 0x73,
	...
	0x74, 0x72, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65,
	0x72, 0x54, 0x79, 0x70, 0x65, 0x55, 0x75, 0x69, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x20, 0x54, 0x65, 0x73, 0x74, 0x49, 0x6e, 0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x54, 0x79, 0x70, 0x65, 0x55, 0x75, 0x69,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x23, 0x54, 0x65, 0x73, 0x74,
	...
	0x4f, 0x76, 0x65, 0x72, 0x54, 0x65, 0x78, 0x74, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x09, 0x52, 0x25,
	...
	0x74, 0x65, 0x64, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a, 0x44, 0x65, 0x70, 0x72, 0x65,
	0x63, 0x61, 0x74, 0x65, 0x64, 0x12, 0x18, 0x0a, 0x07, 0x45, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64,
	0x18, 0x0c, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x45, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x12,
	0x2e, 0x0a, 0x12, 0x4d, 0x61, 0x6a, 0x6f, 0x72, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x4e,
	0x75, 0x6d, 0x62, 0x65, 0x72, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x12, 0x4d, 0x61, 0x6a,
	...
	,
	...
	0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x43, 0x68, 0x69, 0x6c,
	0x64, 0x72, 0x65, 0x6e, 0x18, 0x11, 0x20, 0x03, 0x28, 0x09, 0x52, 0x20, 0x54, 0x65, 0x73, 0x74,
	0x49, 0x6e, 0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x6e, 0x74, 0x61,
	0x69, 0x6e, 0x65, 0x72, 0x43, 0x68, 0x69, 0x6c, 0x64, 0x72, 0x65, 0x6e, 0x2a, 0x57, 0x0a, 0x2f,
	...
	0x46, 0x69, 0x6c, 0x65, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x45, 0x6e, 0x75, 0x6d, 0x12,
	0x13, 0x0a, 0x0b, 0x56, 0x45, 0x52, 0x53, 0x49, 0x4f, 0x4e, 0x5f, 0x30, 0x5f, 0x30, 0x10, 0x00,
	0x1a, 0x02, 0x08, 0x01, 0x12, 0x0f, 0x0a, 0x0b, 0x56, 0x45, 0x52, 0x53, 0x49, 0x4f, 0x4e, 0x5f,
	0x30, 0x5f, 0x31, 0x10, 0x01, 0x2a, 0x6d, 0x0a, 0x0e, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x43, 0x6f,
	...
	0x45, 0x44, 0x10, 0x03, 0x2a, 0x5c, 0x0a, 0x29, 0x54, 0x65, 0x73, 0x74, 0x49, 0x6e, 0x73, 0x74,
	0x72, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72,
	0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x45, 0x6e, 0x75,
	0x6d, 0x12, 0x19, 0x0a, 0x15, 0x50, 0x41, 0x52, 0x41, 0x4c, 0x4c, 0x45, 0x4c, 0x4c, 0x45, 0x44,
	0x5f, 0x50, 0x52, 0x4f, 0x43, 0x45, 0x53, 0x53, 0x45, 0x44, 0x10, 0x00, 0x12, 0x14, 0x0a, 0x10,
	0x53, 0x45, 0x52, 0x49, 0x41, 0x4c, 0x5f, 0x50, 0x52, 0x4f, 0x43, 0x45, 0x53, 0x53, 0x45, 0x44,
	0x10, 0x01, 0x32, 0xc5, 0x05, 0x0a, 0x26, 0x46, 0x65, 0x6e, 0x69, 0x78, 0x54, 0x65, 0x73, 0x74,
	...
	0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0xb3, 0x01, 0x0a, 0x24, 0x47, 0x65, 0x74, 0x54, 0x65, 0x73,
	0x74, 0x49, 0x6e, 0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x41, 0x6e, 0x64,
	0x54, 0x65, 0x73, 0x74, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x73, 0x12, 0x3c,
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x1a, 0x4b, 0x2e, 0x66,
	0x65, 0x6e, 0x69, 0x78, 0x54, 0x65, 0x73, 0x74, 0x43, 0x61, 0x73, 0x65, 0x42, 0x75, 0x69, 0x6c,
	0x64, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x47, 0x72, 0x70, 0x63, 0x41, 0x70, 0x69,
	...
	0x72, 0x73, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x00, 0x12, 0xb9, 0x01, 0x0a, 0x2a,
	0x47, 0x65, 0x74, 0x50, 0x69, 0x6e, 0x6e, 0x65, 0x64, 0x54, 0x65, 0x73, 0x74, 0x49, 0x6e, 0x73,
	0x74, 0x72, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x41, 0x6e, 0x64, 0x54, 0x65, 0x73, 0x74,
	...
	,
...
var file_fenixTestCaseBuilderServerGrpcApi_proto_depIdxs = []int32{
	...
	2,  // 9: fenixTestCaseBuilderServerGrpcApi.TestInstructionContainerMessage.TestInstructionContainerExecutionType:type_name -> fenixTestCaseBuilderServerGrpcApi.TestInstructionContainerExecutionTypeEnum
	3,  // 10: fenixTestCaseBuilderServerGrpcApi.FenixTestCaseBuilderServerGrpcServices.AreYouAlive:input_type -> fenixTestCaseBuilderServerGrpcApi.EmptyParameter
	5,  // 11: fenixTestCaseBuilderServerGrpcApi.FenixTestCaseBuilderServerGrpcServices.GetTestInstructionsAndTestContainers:input_type -> fenixTestCaseBuilderServerGrpcApi.UserIdentificationMessage
	5,  // 12: fenixTestCaseBuilderServerGrpcApi.FenixTestCaseBuilderServerGrpcServices.GetPinnedTestInstructionsAndTestContainers:input_type -> fenixTestCaseBuilderServerGrpcApi.UserIdentificationMessage
	7,  // 13: fenixTestCaseBuilderServerGrpcApi.FenixTestCaseBuilderServerGrpcServices.SendTestInstructionsAndTestContainers:input_type -> fenixTestCaseBuilderServerGrpcApi.PinnedTestInstructionsAndTestContainersMessage
	4,  // 14: fenixTestCaseBuilderServerGrpcApi.FenixTestCaseBuilderServerGrpcServices.AreYouAlive:output_type -> fenixTestCaseBuilderServerGrpcApi.AckNackResponse
	6,  // 15: fenixTestCaseBuilderServerGrpcApi.FenixTestCaseBuilderServerGrpcServices.GetTestInstructionsAndTestContainers:output_type -> fenixTestCaseBuilderServerGrpcApi.TestInstructionsAndTestContainersMessage
	6,  // 16: fenixTestCaseBuilderServerGrpcApi.FenixTestCaseBuilderServerGrpcServices.GetPinnedTestInstructionsAndTestContainers:output_type -> fenixTestCaseBuilderServerGrpcApi.TestInstructionsAndTestContainersMessage
	4,  // 17: fenixTestCaseBuilderServerGrpcApi.FenixTestCaseBuilderServerGrpcServices.SendTestInstructionsAndTestContainers:output_type -> fenixTestCaseBuilderServerGrpcApi.AckNackResponse
