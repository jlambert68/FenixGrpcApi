...
func (TestCasePreviewStructureMessage_MetaDataSelectTypeEnum) Descriptor() protoreflect.EnumDescriptor {
	return file_FenixExecutionServer_fenixExecutionServerGuiGrpcApi_fenixExecutionServerGuiGrpcApi_ListTestCaseExecutions_proto_enumTypes[1].Descriptor()
}

func (TestCasePreviewStructureMessage_MetaDataSelectTypeEnum) Type() protoreflect.EnumType {
	return &file_FenixExecutionServer_fenixExecutionServerGuiGrpcApi_fenixExecutionServerGuiGrpcApi_ListTestCaseExecutions_proto_enumTypes[1]
}
...
func (TestCasePreviewStructureMessage_MetaDataSelectTypeEnum) EnumDescriptor() ([]byte, []int) {
	return file_FenixExecutionServer_fenixExecutionServerGuiGrpcApi_fenixExecutionServerGuiGrpcApi_ListTestCaseExecutions_proto_rawDescGZIP(), []int{5, 1}
}
...
type ListTestCaseExecutionsRequest struct {
	...
	RetrieveAllExecutionsForSpecificTestCaseUuid bool                                            `protobuf:"varint,5,opt,name=RetrieveAllExecutionsForSpecificTestCaseUuid,proto3" json:"RetrieveAllExecutionsForSpecificTestCaseUuid,omitempty"` // Should all TestCaseExecutions be retrieved for attached TestCaseUuid?
	SpecificTestCaseUuid                         string                                          `protobuf:"bytes,6,opt,name=SpecificTestCaseUuid,proto3" json:"SpecificTestCaseUuid,omitempty"`                                                  // TestCaseUuid for which all  all TestCaseExecutions should be retrieved
	TestCaseExecutionFromTimeStamp               *timestamppb.Timestamp                          `protobuf:"bytes,7,opt,name=TestCaseExecutionFromTimeStamp,proto3" json:"TestCaseExecutionFromTimeStamp,omitempty"`                              // Execution From TimeStamp in Request. Filter to be able to select a narrow date span
	TestCaseExecutionToTimeStamp                 *timestamppb.Timestamp                          `protobuf:"bytes,8,opt,name=TestCaseExecutionToTimeStamp,proto3" json:"TestCaseExecutionToTimeStamp,omitempty"`                                  // Execution To TimeStamp in Request. Filter to be able to select a narrow date span
}
...
func (x *ListTestCaseExecutionsRequest) GetBatchSize() int32 {
	if x != nil {
		return x.BatchSize
	}
	return 0
...
func (x *ListTestCaseExecutionsRequest) GetRetrieveAllExecutionsForSpecificTestCaseUuid() bool {
	if x != nil {
		return x.RetrieveAllExecutionsForSpecificTestCaseUuid
	}
	return false
}

func (x *ListTestCaseExecutionsRequest) GetSpecificTestCaseUuid() string {
	if x != nil {
		return x.SpecificTestCaseUuid
	}
	return ""
}

func (x *ListTestCaseExecutionsRequest) GetTestCaseExecutionFromTimeStamp() *timestamppb.Timestamp {
	if x != nil {
...
func (x *ListTestCaseExecutionsRequest) GetTestCaseExecutionToTimeStamp() *timestamppb.Timestamp {
	if x != nil {
...
type TestCaseExecutionsListMessage struct {
	...
	TestCasePreviewHash                          string                                               `protobuf:"bytes,26,opt,name=TestCasePreviewHash,proto3" json:"TestCasePreviewHash,omitempty"`                                                                                   // Comes from TestCasePreview in Database, but is not used here. But is need due to Unmarshal into Proto-message
	NumberOfTestCaseExecutionForTestCase         int32                                                `protobuf:"varint,27,opt,name=NumberOfTestCaseExecutionForTestCase,proto3" json:"NumberOfTestCaseExecutionForTestCase,omitempty"`                                                // The number of TestCaseExecutions this specific TestCaseUuid has produced
}
...
func (x *TestCaseExecutionsListMessage) GetTestCasePreviewHash() string {
	if x != nil {
...
func (x *TestCaseExecutionsListMessage) GetNumberOfTestCaseExecutionForTestCase() int32 {
	if x != nil {
		return x.NumberOfTestCaseExecutionForTestCase
	}
	return 0
}
...
type TestInstructionsExecutionStatusPreviewValuesMessage struct {
	...
	TestCaseName                                string                                               `protobuf:"bytes,3,opt,name=TestCaseName,proto3" json:"TestCaseName,omitempty"`                                                                                        // The name of the TestCases for the execution
	TestCaseExecutionStatus                     TestCaseExecutionStatusEnum                          `protobuf:"varint,4,opt,name=TestCaseExecutionStatus,proto3,enum=fenixExecutionServerGuiGrpcApi.TestCaseExecutionStatusEnum" json:"TestCaseExecutionStatus,omitempty"` // Execution Status for the TestCaseExecution
	TestInstructionExecutionStatusPreviewValues []*TestInstructionExecutionStatusPreviewValueMessage `protobuf:"bytes,5,rep,name=TestInstructionExecutionStatusPreviewValues,proto3" json:"TestInstructionExecutionStatusPreviewValues,omitempty"`                          // A list of all TestInstructionExecutions, and their status, belonging to TestCaseExecution
}
...
func (x *TestInstructionsExecutionStatusPreviewValuesMessage) GetTestCaseExecutionUuid() string {
	if x != nil {
		return x.TestCaseExecutionUuid
	}
	return ""
...
func (x *TestInstructionsExecutionStatusPreviewValuesMessage) GetTestCaseExecutionVersion() int32 {
	if x != nil {
		return x.TestCaseExecutionVersion
	}
	return 0
...
func (x *TestInstructionsExecutionStatusPreviewValuesMessage) GetTestCaseName() string {
	if x != nil {
		return x.TestCaseName
	}
	return ""
...
func (x *TestInstructionsExecutionStatusPreviewValuesMessage) GetTestCaseExecutionStatus() TestCaseExecutionStatusEnum {
	if x != nil {
		return x.TestCaseExecutionStatus
	}
	return TestCaseExecutionStatusEnum_TestCaseExecutionStatusEnum_DEFAULT_NOT_SET
...
type TestCasePreviewStructureMessage_SelectedMetaDataValueMessage struct {
	...
	SelectType        TestCasePreviewStructureMessage_MetaDataSelectTypeEnum `protobuf:"varint,6,opt,name=SelectType,proto3,enum=fenixExecutionServerGuiGrpcApi.TestCasePreviewStructureMessage_MetaDataSelectTypeEnum" json:"SelectType,omitempty"` // Is the MetaData-post single- or multi-select
...
func (x *TestCasePreviewStructureMessage_SelectedMetaDataValueMessage) Reset() {
	*x = TestCasePreviewStructureMessage_SelectedMetaDataValueMessage{}
	if protoimpl.UnsafeEnabled {
		mi := &file_FenixExecutionServer_fenixExecutionServerGuiGrpcApi_fenixExecutionServerGuiGrpcApi_ListTestCaseExecutions_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*TestCasePreviewStructureMessage_SelectedMetaDataValueMessage) Descriptor() ([]byte, []int) {
	return file_FenixExecutionServer_fenixExecutionServerGuiGrpcApi_fenixExecutionServerGuiGrpcApi_ListTestCaseExecutions_proto_rawDescGZIP(), []int{5, 2}
}
...
func (x *TestCasePreviewStructureMessage_TestCaseStructureObjectMessage_TestInstructionAttributeMessage) Reset() {
	*x = TestCasePreviewStructureMessage_TestCaseStructureObjectMessage_TestInstructionAttributeMessage{}
	if protoimpl.UnsafeEnabled {
		mi := &file_FenixExecutionServer_fenixExecutionServerGuiGrpcApi_fenixExecutionServerGuiGrpcApi_ListTestCaseExecutions_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*TestCasePreviewStructureMessage_TestCaseStructureObjectMessage_TestInstructionAttributeMessage) Descriptor() ([]byte, []int) {
	return file_FenixExecutionServer_fenixExecutionServerGuiGrpcApi_fenixExecutionServerGuiGrpcApi_ListTestCaseExecutions_proto_rawDescGZIP(), []int{5, 1, 0}
}
...
var file_FenixExecutionServer_fenixExecutionServerGuiGrpcApi_fenixExecutionServerGuiGrpcApi_ListTestCaseExecutions_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xea, 0x05, 0x0a, 0x1d, 0x4c, 0x69, 0x73, 0x74, 0x54, 0x65, 0x73,
	...
	,
	...
	0x75, 0x0a, 0x16, 0x54, 0x65, 0x73, 0x74, 0x43, 0x61, 0x73, 0x65, 0x45, 0x78, 0x65, 0x63, 0x75,
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x4c, 0x69, 0x73, 0x74, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x3d, 0x2e, 0x66, 0x65, 0x6e, 0x69, 0x78, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e,
	...
	,
	...
	0x18, 0x05, 0x20, 0x01, 0x28, 0x05, 0x52, 0x10, 0x54, 0x65, 0x73, 0x74, 0x53, 0x75, 0x69, 0x74,
	...
	,
	...
	0x75, 0x74, 0x69, 0x6f, 0x6e, 0x55, 0x75, 0x69, 0x64, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x09, 0x52,
	...
	,
	...
	0x75, 0x6d, 0x52, 0x11, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x72, 0x69,
	0x6f, 0x72, 0x69, 0x74, 0x79, 0x12, 0x54, 0x0a, 0x17, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69,
	...
	,
	...
	,
	...
	0x74, 0x61, 0x6d, 0x70, 0x12, 0x7e, 0x0a, 0x1a, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f,
	0x6e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x4c, 0x65, 0x76,
	0x65, 0x6c, 0x18, 0x16, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x3e, 0x2e, 0x66, 0x65, 0x6e, 0x69, 0x78,
	0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x47,
	...
	,
	...
	0x6c, 0x75, 0x65, 0x73, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x52, 0x2c, 0x54, 0x65, 0x73,
	...
	,
	...
	0x65, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f,
	0x6e, 0x12, 0x22, 0x0a, 0x0c, 0x54, 0x65, 0x73, 0x74, 0x43, 0x61, 0x73, 0x65, 0x4e, 0x61, 0x6d,
	0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x54, 0x65, 0x73, 0x74, 0x43, 0x61, 0x73,
	0x65, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x75, 0x0a, 0x17, 0x54, 0x65, 0x73, 0x74, 0x43, 0x61, 0x73,
	0x65, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73,
	0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x3b, 0x2e, 0x66, 0x65, 0x6e, 0x69, 0x78, 0x45, 0x78,
	0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x47, 0x75, 0x69,
	...
	0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0xb3, 0x01, 0x0a,
	...
	0x72, 0x65, 0x76, 0x69, 0x65, 0x77, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x18, 0x05, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x51, 0x2e, 0x66, 0x65, 0x6e, 0x69, 0x78, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74,
	...
	0x75, 0x73, 0x50, 0x72, 0x65, 0x76, 0x69, 0x65, 0x77, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x4d, 0x65,
	0x73, 0x73, 0x61, 0x67, 0x65, 0x52, 0x2b, 0x54, 0x65, 0x73, 0x74, 0x49, 0x6e, 0x73, 0x74, 0x72,
	...
	0x65, 0x73, 0x22, 0xdc, 0x06, 0x0a, 0x31, 0x54, 0x65, 0x73, 0x74, 0x49, 0x6e, 0x73, 0x74, 0x72,
	0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x53,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x50, 0x72, 0x65, 0x76, 0x69, 0x65, 0x77, 0x56, 0x61, 0x6c, 0x75,
	...
	,
	...
	0x6e, 0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x40,
	...
	,
	...
	0x43, 0x61, 0x73, 0x65, 0x53, 0x74, 0x72, 0x75, 0x63, 0x74, 0x75, 0x72, 0x65, 0x4f, 0x62, 0x6a,
	0x65, 0x63, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x52, 0x18, 0x54, 0x65, 0x73, 0x74,
	0x43, 0x61, 0x73, 0x65, 0x53, 0x74, 0x72, 0x75, 0x63, 0x74, 0x75, 0x72, 0x65, 0x4f, 0x62, 0x6a,
	0x65, 0x63, 0x74, 0x73, 0x12, 0x3c, 0x0a, 0x19, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x78, 0x54,
	0x65, 0x78, 0x74, 0x75, 0x61, 0x6c, 0x44, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f,
	0x6e, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x19, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x78,
	...
	,
	...
	0x75, 0x63, 0x74, 0x75, 0x72, 0x65, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2e, 0x53, 0x65,
	0x6c, 0x65, 0x63, 0x74, 0x65, 0x64, 0x4d, 0x65, 0x74, 0x61, 0x44, 0x61, 0x74, 0x61, 0x56, 0x61,
	0x6c, 0x75, 0x65, 0x73, 0x4d, 0x61, 0x70, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x19, 0x53, 0x65,
	0x6c, 0x65, 0x63, 0x74, 0x65, 0x64, 0x4d, 0x65, 0x74, 0x61, 0x44, 0x61, 0x74, 0x61, 0x56, 0x61,
	0x6c, 0x75, 0x65, 0x73, 0x4d, 0x61, 0x70, 0x1a, 0xaa, 0x01, 0x0a, 0x1e, 0x53, 0x65, 0x6c, 0x65,
	...
	0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x72, 0x0a, 0x05,
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x5c, 0x2e, 0x66, 0x65,
	0x6e, 0x69, 0x78, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x65, 0x72, 0x76,
	...
	,
	...
	,
	...
	,
	...
	0x6f, 0x6e, 0x43, 0x6f, 0x6c, 0x6f, 0x72, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x14, 0x54,
	0x65, 0x73, 0x74, 0x49, 0x6e, 0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x6f,
	0x6c, 0x6f, 0x72, 0x12, 0xbc, 0x01, 0x0a, 0x19, 0x54, 0x65, 0x73, 0x74, 0x49, 0x6e, 0x73, 0x74,
	0x72, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65,
	0x73, 0x18, 0x09, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x7e, 0x2e, 0x66, 0x65, 0x6e, 0x69, 0x78, 0x45,
	...
	0x65, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2e, 0x54, 0x65, 0x73, 0x74, 0x43, 0x61, 0x73,
	0x65, 0x53, 0x74, 0x72, 0x75, 0x63, 0x74, 0x75, 0x72, 0x65, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74,
	...
	,
...
var file_FenixExecutionServer_fenixExecutionServerGuiGrpcApi_fenixExecutionServerGuiGrpcApi_ListTestCaseExecutions_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_FenixExecutionServer_fenixExecutionServerGuiGrpcApi_fenixExecutionServerGuiGrpcApi_ListTestCaseExecutions_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_FenixExecutionServer_fenixExecutionServerGuiGrpcApi_fenixExecutionServerGuiGrpcApi_ListTestCaseExecutions_proto_goTypes = []interface{}{
	...
	(TestCasePreviewStructureMessage_MetaDataSelectTypeEnum)(0),            // 1: fenixExecutionServerGuiGrpcApi.TestCasePreviewStructureMessage.MetaDataSelectTypeEnum
	(*ListTestCaseExecutionsRequest)(nil),                                  // 2: fenixExecutionServerGuiGrpcApi.ListTestCaseExecutionsRequest
	(*ListTestCaseExecutionsResponse)(nil),                                 // 3: fenixExecutionServerGuiGrpcApi.ListTestCaseExecutionsResponse
	(*TestCaseExecutionsListMessage)(nil),                                  // 4: fenixExecutionServerGuiGrpcApi.TestCaseExecutionsListMessage
	(*TestInstructionsExecutionStatusPreviewValuesMessage)(nil),            // 5: fenixExecutionServerGuiGrpcApi.TestInstructionsExecutionStatusPreviewValuesMessage
	(*TestInstructionExecutionStatusPreviewValueMessage)(nil),              // 6: fenixExecutionServerGuiGrpcApi.TestInstructionExecutionStatusPreviewValueMessage
	(*TestCasePreviewStructureMessage)(nil),                                // 7: fenixExecutionServerGuiGrpcApi.TestCasePreviewStructureMessage
	nil,                                                                    // 8: fenixExecutionServerGuiGrpcApi.TestCasePreviewStructureMessage.SelectedMetaDataValuesMapEntry
	(*TestCasePreviewStructureMessage_TestCaseStructureObjectMessage)(nil), // 9: fenixExecutionServerGuiGrpcApi.TestCasePreviewStructureMessage.TestCaseStructureObjectMessage
	(*TestCasePreviewStructureMessage_SelectedMetaDataValueMessage)(nil),   // 10: fenixExecutionServerGuiGrpcApi.TestCasePreviewStructureMessage.SelectedMetaDataValueMessage
	(*TestCasePreviewStructureMessage_TestCaseStructureObjectMessage_TestInstructionAttributeMessage)(nil), // 11: fenixExecutionServerGuiGrpcApi.TestCasePreviewStructureMessage.TestCaseStructureObjectMessage.TestInstructionAttributeMessage
	(*UserAndApplicationRunTimeIdentificationMessage)(nil),                                                 // 12: fenixExecutionServerGuiGrpcApi.UserAndApplicationRunTimeIdentificationMessage
	(*timestamppb.Timestamp)(nil),           // 13: google.protobuf.Timestamp
	(*AckNackResponse)(nil),                 // 14: fenixExecutionServerGuiGrpcApi.AckNackResponse
	(ExecutionPriorityEnum)(0),              // 15: fenixExecutionServerGuiGrpcApi.ExecutionPriorityEnum
	(TestCaseExecutionStatusEnum)(0),        // 16: fenixExecutionServerGuiGrpcApi.TestCaseExecutionStatusEnum
	(ExecutionStatusReportLevelEnum)(0),     // 17: fenixExecutionServerGuiGrpcApi.ExecutionStatusReportLevelEnum
	(TestInstructionExecutionStatusEnum)(0), // 18: fenixExecutionServerGuiGrpcApi.TestInstructionExecutionStatusEnum
}
var file_FenixExecutionServer_fenixExecutionServerGuiGrpcApi_fenixExecutionServerGuiGrpcApi_ListTestCaseExecutions_proto_depIdxs = []int32{
	12, // 0: fenixExecutionServerGuiGrpcApi.ListTestCaseExecutionsRequest.UserAndApplicationRunTimeIdentification:type_name -> fenixExecutionServerGuiGrpcApi.UserAndApplicationRunTimeIdentificationMessage
	13, // 1: fenixExecutionServerGuiGrpcApi.ListTestCaseExecutionsRequest.TestCaseExecutionFromTimeStamp:type_name -> google.protobuf.Timestamp
	13, // 2: fenixExecutionServerGuiGrpcApi.ListTestCaseExecutionsRequest.TestCaseExecutionToTimeStamp:type_name -> google.protobuf.Timestamp
	14, // 3: fenixExecutionServerGuiGrpcApi.ListTestCaseExecutionsResponse.ackNackResponse:type_name -> fenixExecutionServerGuiGrpcApi.AckNackResponse
	4,  // 4: fenixExecutionServerGuiGrpcApi.ListTestCaseExecutionsResponse.TestCaseExecutionsList:type_name -> fenixExecutionServerGuiGrpcApi.TestCaseExecutionsListMessage
	13, // 5: fenixExecutionServerGuiGrpcApi.TestCaseExecutionsListMessage.QueueTimeStamp:type_name -> google.protobuf.Timestamp
	15, // 6: fenixExecutionServerGuiGrpcApi.TestCaseExecutionsListMessage.ExecutionPriority:type_name -> fenixExecutionServerGuiGrpcApi.ExecutionPriorityEnum
	13, // 7: fenixExecutionServerGuiGrpcApi.TestCaseExecutionsListMessage.ExecutionStartTimeStamp:type_name -> google.protobuf.Timestamp
	13, // 8: fenixExecutionServerGuiGrpcApi.TestCaseExecutionsListMessage.ExecutionStopTimeStamp:type_name -> google.protobuf.Timestamp
	16, // 9: fenixExecutionServerGuiGrpcApi.TestCaseExecutionsListMessage.TestCaseExecutionStatus:type_name -> fenixExecutionServerGuiGrpcApi.TestCaseExecutionStatusEnum
	13, // 10: fenixExecutionServerGuiGrpcApi.TestCaseExecutionsListMessage.ExecutionStatusUpdateTimeStamp:type_name -> google.protobuf.Timestamp
	17, // 11: fenixExecutionServerGuiGrpcApi.TestCaseExecutionsListMessage.ExecutionStatusReportLevel:type_name -> fenixExecutionServerGuiGrpcApi.ExecutionStatusReportLevelEnum
	7,  // 12: fenixExecutionServerGuiGrpcApi.TestCaseExecutionsListMessage.TestCasePreview:type_name -> fenixExecutionServerGuiGrpcApi.TestCasePreviewStructureMessage
	5,  // 13: fenixExecutionServerGuiGrpcApi.TestCaseExecutionsListMessage.TestInstructionsExecutionStatusPreviewValues:type_name -> fenixExecutionServerGuiGrpcApi.TestInstructionsExecutionStatusPreviewValuesMessage
	16, // 14: fenixExecutionServerGuiGrpcApi.TestInstructionsExecutionStatusPreviewValuesMessage.TestCaseExecutionStatus:type_name -> fenixExecutionServerGuiGrpcApi.TestCaseExecutionStatusEnum
	6,  // 15: fenixExecutionServerGuiGrpcApi.TestInstructionsExecutionStatusPreviewValuesMessage.TestInstructionExecutionStatusPreviewValues:type_name -> fenixExecutionServerGuiGrpcApi.TestInstructionExecutionStatusPreviewValueMessage
	13, // 16: fenixExecutionServerGuiGrpcApi.TestInstructionExecutionStatusPreviewValueMessage.SentTimeStamp:type_name -> google.protobuf.Timestamp
	13, // 17: fenixExecutionServerGuiGrpcApi.TestInstructionExecutionStatusPreviewValueMessage.TestInstructionExecutionEndTimeStamp:type_name -> google.protobuf.Timestamp
	18, // 18: fenixExecutionServerGuiGrpcApi.TestInstructionExecutionStatusPreviewValueMessage.TestInstructionExecutionStatus:type_name -> fenixExecutionServerGuiGrpcApi.TestInstructionExecutionStatusEnum
	9,  // 19: fenixExecutionServerGuiGrpcApi.TestCasePreviewStructureMessage.TestCaseStructureObjects:type_name -> fenixExecutionServerGuiGrpcApi.TestCasePreviewStructureMessage.TestCaseStructureObjectMessage
	8,  // 20: fenixExecutionServerGuiGrpcApi.TestCasePreviewStructureMessage.SelectedMetaDataValuesMap:type_name -> fenixExecutionServerGuiGrpcApi.TestCasePreviewStructureMessage.SelectedMetaDataValuesMapEntry
	10, // 21: fenixExecutionServerGuiGrpcApi.TestCasePreviewStructureMessage.SelectedMetaDataValuesMapEntry.value:type_name -> fenixExecutionServerGuiGrpcApi.TestCasePreviewStructureMessage.SelectedMetaDataValueMessage
	0,  // 22: fenixExecutionServerGuiGrpcApi.TestCasePreviewStructureMessage.TestCaseStructureObjectMessage.TestCaseStructureObjectType:type_name -> fenixExecutionServerGuiGrpcApi.TestCasePreviewStructureMessage.TestCaseStructureObjectTypeEnum
	11, // 23: fenixExecutionServerGuiGrpcApi.TestCasePreviewStructureMessage.TestCaseStructureObjectMessage.TestInstructionAttributes:type_name -> fenixExecutionServerGuiGrpcApi.TestCasePreviewStructureMessage.TestCaseStructureObjectMessage.TestInstructionAttributeMessage
	1,  // 24: fenixExecutionServerGuiGrpcApi.TestCasePreviewStructureMessage.SelectedMetaDataValueMessage.SelectType:type_name -> fenixExecutionServerGuiGrpcApi.TestCasePreviewStructureMessage.MetaDataSelectTypeEnum
...
func file_FenixExecutionServer_fenixExecutionServerGuiGrpcApi_fenixExecutionServerGuiGrpcApi_ListTestCaseExecutions_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_FenixExecutionServer_fenixExecutionServerGuiGrpcApi_fenixExecutionServerGuiGrpcApi_ListTestCaseExecutions_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_FenixExecutionServer_fenixExecutionServerGuiGrpcApi_fenixExecutionServerGuiGrpcApi_ListTestCaseExecutions_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
