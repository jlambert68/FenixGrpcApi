...
type ListTestCaseExecutionsRequest struct {
	...
	TestCaseExecutionFromTimeStamp               *timestamp.Timestamp                            `protobuf:"bytes,7,opt,name=TestCaseExecutionFromTimeStamp,proto3" json:"TestCaseExecutionFromTimeStamp,omitempty"`                              // Execution From TimeStamp in Request. Filter to be able to select a narrow date span
	TestCaseExecutionToTimeStamp                 *timestamp.Timestamp                            `protobuf:"bytes,8,opt,name=TestCaseExecutionToTimeStamp,proto3" json:"TestCaseExecutionToTimeStamp,omitempty"`                                  // Execution To TimeStamp in Request. Filter to be able to select a narrow date span
}
