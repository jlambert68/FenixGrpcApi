...
const (
	...
	FenixExecutionWorkerConnectorGrpcServices_ConnectorPublishSupportedSubInstructions_FullMethodName                                             = "/fenixExecutionWorkerGrpcApi.FenixExecutionWorkerConnectorGrpcServices/ConnectorPublishSupportedSubInstructions"
)
...
func (c *fenixExecutionWorkerConnectorGrpcServicesClient) ConnectorPublishSupportedMetaData(ctx context.Context, in *SupportedTestCaseAndTestSuiteMetaData, opts ...grpc.CallOption) (*AckNackResponse, error) {
	out := new(AckNackResponse)
...
func (c *fenixExecutionWorkerConnectorGrpcServicesClient) ConnectorPublishSupportedSubInstructions(ctx context.Context, in *SupportedSubInstructions, opts ...grpc.CallOption) (*AckNackResponse, error) {
	out := new(AckNackResponse)
	err := c.cc.Invoke(ctx, FenixExecutionWorkerConnectorGrpcServices_ConnectorPublishSupportedSubInstructions_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedFenixExecutionWorkerConnectorGrpcServicesServer) ConnectorPublishSupportedMetaData(context.Context, *SupportedTestCaseAndTestSuiteMetaData) (*AckNackResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ConnectorPublishSupportedMetaData not implemented")
}
func (UnimplementedFenixExecutionWorkerConnectorGrpcServicesServer) ConnectorPublishSupportedSubInstructions(context.Context, *SupportedSubInstructions) (*AckNackResponse, error) {
...
func _FenixExecutionWorkerConnectorGrpcServices_ConnectorPublishSupportedMetaData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FenixExecutionWorkerConnectorGrpcServicesServer).ConnectorPublishSupportedMetaData(ctx, req.(*SupportedTestCaseAndTestSuiteMetaData))
	}
	return interceptor(ctx, in, info, handler)
}

func _FenixExecutionWorkerConnectorGrpcServices_ConnectorPublishSupportedSubInstructions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SupportedSubInstructions)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FenixExecutionWorkerConnectorGrpcServicesServer).ConnectorPublishSupportedSubInstructions(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FenixExecutionWorkerConnectorGrpcServices_ConnectorPublishSupportedSubInstructions_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FenixExecutionWorkerConnectorGrpcServicesServer).ConnectorPublishSupportedSubInstructions(ctx, req.(*SupportedSubInstructions))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FenixExecutionWorkerConnectorGrpcServices_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _FenixExecutionWorkerConnectorGrpcServices_ConnectorPublishSupportedSubInstructions_Handler,
		},
	},
	Streams: []grpc.StreamDesc{
		{
